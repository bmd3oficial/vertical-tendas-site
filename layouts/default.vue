          ...
          >
            ...
            <div>
              <div class="mb-8">
                ...
                <div class="space-y-2">
                  <div v-if="apiStore.contact.whatsapp" class="flex items-center gap-2">
                  ...
                  <div v-if="apiStore.contact.whatsappalternative" class="flex items-center gap-2">
                    ...
                    <a
                      :href="`https://wa.me/55${apiStore.contact.whatsappalternative.replace(
                        /\D/g,
                        ''
                      )}`"
                      target="_blank"
                    ...
                    >
                      ...
                      <span class="text-xs ml-1 text-gray-500">(Alternativo)</span>
                    </a>
                  </div>
                </div>
              </div>
