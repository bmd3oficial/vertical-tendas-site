...
<template>
  <div>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K3D2VK93"
    height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
    <header
      class="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60"
    >
      <nav class="flex justify-between w-full items-center px-4 py-2 sm:px-6 md:px-8 lg:px-12">
        <NuxtLink
          :to="{ name: 'index' }"
          ...
          >
            ...
            <div>
              <div class="mb-8">
                ...
                <div class="space-y-2">
                  <div v-if="apiStore.contact.whatsapp" class="flex flex-col gap-2">
